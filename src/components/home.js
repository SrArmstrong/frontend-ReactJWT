  ...
  return (
    <div className="container d-flex justify-content-center align-items-center vh-100">
      ...
      <div className="card shadow-lg p-4 text-center">
        ...
        <button className="btn btn-danger m-2" onClick={() => handleApiCall('deleteUser', {}, { username: 'usuarioEjemplo' })}>Eliminar Usuario</button>
        <button className="btn btn-warning m-2" onClick={() => handleApiCall('updateUser', { key: 'value' }, { username: 'usuarioEjemplo' })}>Actualizar Usuario</button>
        <button className="btn btn-warning m-2" onClick={() => handleApiCall('updateRole', { role: 'nuevoRol' }, { username: 'usuarioEjemplo' })}>Actualizar Rol</button>
        <button className="btn btn-success m-2" onClick={() => handleApiCall('addRole', { role: 'nuevoRol', permissions: [] })}>Agregar Rol</button>
        <button className="btn btn-danger m-2" onClick={() => handleApiCall('deleteRole', {}, { role: 'rolEjemplo' })}>Eliminar Rol</button>
        <button className="btn btn-info m-2" onClick={() => handleApiCall('addPermission', { permission: 'nuevoPermiso' }, { role: 'rolEjemplo' })}>Agregar Permiso</button>
        <button className="btn btn-danger m-2" onClick={() => handleApiCall('deletePermission', {}, { role: 'rolEjemplo', permission: 'permisoEjemplo' })}>Eliminar Permiso</button>
        </div>
